...
local white = "#c6c6c6"
local bg = black
if g.moonflyTransparent then bg = none end
...
M.style = function()
    ...
    -- Misc helpers
    highlight(0, "MoonflyWhiteAlert", {bg = bg, fg = white})
    highlight(0, "MoonflyYellowAlert", {bg = bg, fg = yellow})
    highlight(0, "MoonflyCoralAlert", {bg = bg, fg = coral})
    highlight(0, "MoonflyEmeraldAlert", {bg = bg, fg = emerald})
    highlight(0, "MoonflySkyAlert", {bg = bg, fg = sky})
    highlight(0, "MoonflyRedAlert", {bg = bg, fg = red})
    ...
    highlight(0, "MoonflyDiagnosticUndercurlWarn",
              {undercurl = true, sp = yellow})
    highlight(0, "MoonflyDiagnosticUndercurlInfo", {undercurl = true, sp = sky})
    highlight(0, "MoonflyDiagnosticUndercurlHint",
              {undercurl = true, sp = white})
    highlight(0, "MoonflyDiagnosticUnderlineError", {underline = true, sp = red})
    highlight(0, "MoonflyDiagnosticUnderlineWarn",
              {underline = true, sp = yellow})
    highlight(0, "MoonflyDiagnosticUnderlineInfo", {underline = true, sp = sky})
    highlight(0, "MoonflyDiagnosticUnderlineHint",
              {underline = true, sp = white})
    ...
    if g.moonflyUndercurls then
        ...
        highlight(0, "SpellBad",
                  {bg = none, fg = red, underline = true, sp = red})
        highlight(0, "SpellCap",
                  {bg = none, fg = blue, underline = true, sp = blue})
        highlight(0, "SpellRare",
                  {bg = none, fg = yellow, underline = true, sp = yellow})
        highlight(0, "SpellLocal",
                  {bg = none, fg = sky, underline = true, sp = sky})
    end
    ...
    highlight(0, "@lsp.typemod.enumMember.defaultLibrary",
              {link = "@constant.builtin"})
    highlight(0, "@lsp.typemod.function.defaultLibrary",
              {link = "@function.builtin"})
    highlight(0, "@lsp.typemod.keyword.async", {link = "@keyword"})
    highlight(0, "@lsp.typemod.method.defaultLibrary",
              {link = "@function.builtin"})
    highlight(0, "@lsp.typemod.operator.injected", {link = "@operator"})
    highlight(0, "@lsp.typemod.string.injected", {link = "@string"})
    highlight(0, "@lsp.typemod.variable.defaultLibrary",
    ...
    if g.moonflyUndercurls then
        highlight(0, "DiagnosticUnderlineError",
                  {link = "MoonflyDiagnosticUndercurlError"})
        highlight(0, "DiagnosticUnderlineWarn",
                  {link = "MoonflyDiagnosticUndercurlWarn"})
        highlight(0, "DiagnosticUnderlineInfo",
                  {link = "MoonflyDiagnosticUndercurlInfo"})
        highlight(0, "DiagnosticUnderlineHint",
                  {link = "MoonflyDiagnosticUndercurlHint"})
    else
        highlight(0, "DiagnosticUnderlineError",
                  {link = "MoonflyDiagnosticUnderlineError"})
        highlight(0, "DiagnosticUnderlineWarn",
                  {link = "MoonflyDiagnosticUnderlineWarn"})
        highlight(0, "DiagnosticUnderlineInfo",
                  {link = "MoonflyDiagnosticUnderlineInfo"})
        highlight(0, "DiagnosticUnderlineHint",
                  {link = "MoonflyDiagnosticUnderlineHint"})
    end
    if g.moonflyVirtualTextColor then
        highlight(0, "DiagnosticVirtualTextError",
                  {link = "MoonflyDiagnosticVirtualTextError"})
        highlight(0, "DiagnosticVirtualTextWarn",
                  {link = "MoonflyDiagnosticVirtualTextWarn"})
        highlight(0, "DiagnosticVirtualTextInfo",
                  {link = "MoonflyDiagnosticVirtualTextInfo"})
        highlight(0, "DiagnosticVirtualTextHint",
                  {link = "MoonflyDiagnosticVirtualTextHint"})
    else
    ...
    highlight(0, "IndentBlanklineSpaceCharBlankline",
              {fg = grey235, nocombine = true})
    ...
    highlight(0, "MiniTablineModifiedCurrent",
              {link = "MoonflyYellowLineActive"})
    ...
    highlight(0, "MasonHighlightBlockBoldSecondary",
              {link = "MoonflyEmeraldMode"})
