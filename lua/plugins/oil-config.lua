...
local edit_path = xdg_config_home .. '/' .. nvim_appname .. '/lua'
...
local keyz = {
    ...
    {"me", "<cmd>Neotree " .. edit_path .. "<CR>", "Edit Config"}, 
    { "mo", function() require("oil").open_float(edit_path) end, desc = "Oil Edit Config" }, {"mE", "<cmd>Neotree " .. lazyvim_path .. "<CR>", "Edit Lazyvim Config"},
    {"mO", '<cmd>Oil --float ' .. lazyvim_path .. '<CR>', "Oil LazyVim Config"}
}
